<template>
  <div>
    <div class="">
      ...
      <!-- {{ blogs.length }} -->
      <div v-if="isLoading" class="px-4 md:px-16">Fetching data ....</div>
      <div v-else-if="blogs == null" class="px-4 md:px-16">
        No data available ...
      </div>
      <div class="">
        <section class="mb-16">
      ...
      <div class="mb-16 px-4 md:px-8">
        <nuxt-link class="text-indigo-600 flex" to="/blogs"
          >All Blogs
          <svg
            class="w-3.5 h-3.5 ml-2 mt-1.5"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 14 10"
